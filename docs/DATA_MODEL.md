...
└─ Array<MaterialEntry> Entries
     MaterialEntry { string Id; string DisplayName; string MaterialPath; string TexturePath;
                     float UvScale; Color Tint; }   // UvScale/Tint apply to texture-built materials only
```
